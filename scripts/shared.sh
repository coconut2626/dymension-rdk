...
KEY_NAME_ROLLAPP1=${KEY_NAME_ROLLAPP1:-"rol-user1"}
KEY_NAME_ROLLAPP2=${KEY_NAME_ROLLAPP2:-"rol-user2"}
KEY_NAME_ROLLAPP3=${KEY_NAME_ROLLAPP3:-"rol-user3"}
KEY_NAME_ROLLAPP4=${KEY_NAME_ROLLAPP4:-"rol-user4"}
KEY_NAME_ROLLAPP5=${KEY_NAME_ROLLAPP5:-"rol-user5"}
KEY_NAME_ROLLAPP6=${KEY_NAME_ROLLAPP6:-"rol-user6"}
KEY_NAME_ROLLAPP7=${KEY_NAME_ROLLAPP7:-"rol-user7"}
KEY_NAME_ROLLAPP8=${KEY_NAME_ROLLAPP8:-"rol-user8"}
DENOM=${DENOM:-"urax"}
